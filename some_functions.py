...
def index_prospective(rotation, scale, translation):
    z = int(translation[2])
    if z <= 2500:
        z = 2500
    elif z >= 7000:
    ...
    # distance_crop: between 80 and 375
    diff_n = ((7000 - z)/4500)*295
    z = int(375 - diff_n)
    ...
    # normalize respect the frame size
    x = x / 225
    y = y / 300
    # print(x, y)

    offset_x = (x * 1125 - (z*2*0.75))/4
    offset_y = (y * 1500 - z*2)/4

    return int(offset_x), int(offset_y), z
